...
/**
 * Creates a unique placeholder URL by appending a fragment identifier with the promptId
...
export function createPlaceholderUrl(promptId: string): string {
  return `${PLACEHOLDER_IMAGE_URL}#promptId=${encodeURIComponent(promptId)}`;
}
